...
def carregar_dados_creditos(_engine):
    """Carrega dados das tabelas DIME."""
    dados = {}
        ...
        try:
            ...
            if key == 'tech':
                ...
                if 'flag_setor_tech' in df.columns:
                    ...
                    st.sidebar.write(f"  ✓ Colunas: {df.columns.tolist()[:5]}...")
                else:
...
def calcular_estatisticas_setoriais(dados, periodo='12m'):
    """Calcula estatísticas dos 3 setores."""
    setores = []
    ...
    for setor_key, setor_nome, flag_col in [
        ...
        st.sidebar.write(f"    ✅ Adicionado ao resultado!")
...
def pagina_analise_suspeitas(dados, filtros):
    ...
    # Empresas com Múltiplos Alertas
    st.divider()
...
def pagina_analise_setorial(dados, filtros):
    ...
    stats_setores = calcular_estatisticas_setoriais(dados, periodo)
...
def pagina_drill_down_empresa(dados, filtros):
    ...
    with col1:
        st.caption(f"**CNPJ:** {empresa_info['nu_cnpj']}")
